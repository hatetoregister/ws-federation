<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="WS.Federation.Samples.RelyingParty.WebForms.Account.OpenAuthProviders" %>
