<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="WS.Federation.Samples.RelyingParty.WebForms.Account.Manage" %>
